...
pub enum LocaleKey {
    ...
    BtnAfkSettings,
    BtnAfkToggle,
    BtnAfkThresholdMinus,
    BtnAfkThresholdPlus,
    BtnAfkCooldownMinus,
    BtnAfkCooldownPlus,
    BtnAfkManageBlacklist,
    BtnAfkManageWhitelist,
    BtnAfkManageOverrides,
    BtnAfkModeNone,
    BtnAfkModeBlacklist,
    BtnAfkModeWhitelist,
    BtnNotifSettings,
    ...
    NotifSettingsTitle,
    AfkSettingsTitle,
    AfkListTitleBlacklist,
    AfkListTitleWhitelist,
    AfkListTitleNone,
    AfkOverridesTitle,
    ToastAfkUpdated,
    ToastAfkThresholdUpdated,
    ToastAfkCooldownUpdated,
    ToastAfkModeUpdated,
    ToastAfkListUpdated,
    ToastAfkOverrideDeleted,
    ToastAfkOverrideUpdated,
    ToastAfkSwitchModeFirst,
    QueueSettingsTitle,

...
admin-error-system = Системная ошибка в { $context }: { $error }
...
admin-error-context-update-listener = обработчике обновлений Telegram
...
display-unknown-user = Неизвестный пользователь
